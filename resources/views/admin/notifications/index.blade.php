    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Pemberitahuan terkait sistem</p>
            </div>
            ...
            <div class="divide-y divide-slate-50">
                    ...
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                @if(!$notif->is_read)
                                    <form action="{{ route('admin.notifications.read', $notif) }}" method="POST" class="shrink-0">
                                        @csrf @method('PATCH')
                ...
                @empty
                    <div class="px-6 py-16 text-center">
                        ...
                        <p class="text-sm text-slate-400 mt-1">Notifikasi akan muncul saat ada update</p>
                    </div>
                @endforelse
            </div>
        </div>
