...
@section('content')
    <div class="w-full max-w-md mx-auto px-4  ">
        <div class="text-center mb-8 animate-float">
            ...
            <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-gold-200 to-white tracking-tight drop-shadow-lg">SIRUANG</h1>
